...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <section className="flex  min-h-screen w-full items-center justify-center gap-4 bg-[url(/images/auth-light.png)] bg-cover bg-center bg-no-repeat px-4 py-10 dark:bg-[url(/images/auth-dark.png)]">
      <div className="light-border background-light800_dark200 ms:min-w-[520px] rounded-[10px] border px-4 py-10 shadow-light-100 sm:px-8">
        <div className="light-border flex items-center justify-between gap-y-2 border-b pb-6">
