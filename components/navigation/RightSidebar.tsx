      ...
      <div>
        ...
        <div className="mt-7 flex w-full flex-col gap-[30px]">
          {hotQuesions.map(({ id, title }) => (
            ...
            >
              <p className="body-medium group-hover:text-dark-400 group-hover:dark:text-light-800 text-dark500_light700  transition-all duration-200 group-hover:italic">
                {title}
              </p>
              <Image
